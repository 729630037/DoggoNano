...
class MinitaurGymEnv(gym.Env):
  ...
  def _transform_action_to_motor_command(self, action):
    ...
    if self._leg_model_enabled:
      ...
      action_convertFromLegModel = self.minitaur.ConvertFromLegModel(action)
    return action,action_convertFromLegModel
  ...
  def _get_observation(self):
    ...
    observation.extend(list(self.minitaur.GetTrueXYZRate()))
