...
INIT_POSITION = [0, 0, .185]
INIT_RACK_POSITION = [0, 0, 1]
INIT_ORIENTATION = [0, 0, 0, 1]
KNEE_CONSTRAINT_POINT_RIGHT = [0, 0.005, 0.168]
KNEE_CONSTRAINT_POINT_LEFT = [0, 0.01, 0.168]
...
class Minitaur(object):
  ...
  def __init__(self,
    ...
    self.init_position = ROBOT_INIT_POSITION[terrain_id]
