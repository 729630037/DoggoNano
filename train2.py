...
env_name = "MinitaurTrottingEnv-v0" # @param {type:"string"}
...
collect_env = suite_pybullet.load(env_name,max_episode_steps=200)
eval_env = suite_pybullet.load(env_name,max_episode_steps=200)
